...
interface ClientesB2BPanelProps {
  clients: B2BClient[];
...
export default function ClientesB2BPanel({
  clients,
  onUpdateClient,
  onAddClient,
  onDeleteClient,
      ...
      {viewLevel === 1 && (
        <>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-black text-zinc-900 tracking-tight uppercase">Cartera de Agencias B2B</h2>
